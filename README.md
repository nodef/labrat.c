...
A simple, single-file test harness for C/C++, by [Alex Thayer](https://github.com/squarewave). Allows specifying test cases and
...
![](https://ga-beacon.deno.dev/G-RC63DPBH3P:SH3Eq-NoQ9mwgYeHWxu7cw/github.com/nodef/labrat.c)
[![SRC](https://img.shields.io/badge/src-repo-green?logo=Org)](https://github.com/squarewave/labrat)
